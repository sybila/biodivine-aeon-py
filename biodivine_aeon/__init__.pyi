from typing import Literal, Callable, Sequence, TypedDict, Iterator, overload, Mapping, Union, Optional, Any
...
class BbmModel: 
    ...
    def to_bn_default() -> BooleanNetwork: ...
    def to_bn_inputs_true() -> BooleanNetwork: ...
    def to_bn_inputs_false() -> BooleanNetwork: ...
    def to_bn_inputs_random(instance_count: int, random_seed: int) -> list[BooleanNetwork]: ...
...
class BbmFilterConfig:
    @staticmethod
    def new() -> BbmFilterConfig: ...
    @staticmethod
    def from_json_file(path: str) -> BbmFilterConfig: ...
    @staticmethod
    def from_json(json_str: str) -> BbmFilterConfig: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
