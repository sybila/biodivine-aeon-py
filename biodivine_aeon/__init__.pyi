from typing import TypeAlias, Literal, Callable, Sequence, TypedDict, NotRequired, Iterable, Iterator
...
class SymbolicContext:
    ...
    def get_function_name(self, function: VariableId | ParameterId | str) -> str: ...
    ...
    def mk_function(self, function: VariableId | ParameterId | str, arguments: list[UpdateFunction] | list[Bdd]) -> Bdd: ...
