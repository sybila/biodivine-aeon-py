...
class Class:
    @staticmethod
    def classification_ensure(classification: dict[Class, ColorSet], features: Class, colors: ColorSet) -> dict[Class, ColorSet]: ...
    @staticmethod
    def classification_append(classification: dict[Class, ColorSet], features: Class, colors: ColorSet) -> dict[Class, ColorSet]: ...
