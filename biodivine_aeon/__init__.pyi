...
class ColoredPerturbationSet:
    ...
    def select_perturbation(self, perturbations: Mapping[VariableIdType, Optional[bool]]) -> ColorSet: ...
    def perturbation_robustness(self, perturbations: Mapping[VariableIdType, Optional[bool]]) -> float: ...
    def select_by_robustness(self, threshold: float, size_limit: Optional[int] = None, result_limit: Optional[int] = None) -> list[tuple[PerturbationModel, float, ColorSet]]: ...
