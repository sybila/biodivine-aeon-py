...
class Bdd:
    ...
    def to_expression(self) -> BooleanExpression:
        ...
    def to_dnf(self, optimize: bool = True, size_limit: Optional[int] = None, simplify_monotonicity: bool = True) -> list[BddPartialValuation]:
        ...
...
class BooleanNetwork(RegulatoryGraph):
    ...
    def infer_valid_graph(self) -> BooleanNetwork:
        ...
    def check_regulation_constraints(self) -> list[str]:
        ...
